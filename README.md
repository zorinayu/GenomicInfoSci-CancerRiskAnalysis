...
- To what extent can a mechanistic somatic-mutation model reproduce the empirical age鈥搃ncidence curve from SEER/USCS data?
- How do changes in mutation rate, repair efficiency, and clonal threshold alter the age鈥搑isk relationship?
...
```
FinalProject/
鈹溾攢鈹€ src/                    # Source code modules
鈹?  鈹溾攢鈹€ __init__.py
鈹?  鈹溾攢鈹€ data_loader.py      # Data loading utilities
鈹?  鈹溾攢鈹€ utils.py            # Utility functions
鈹?  鈹溾攢鈹€ visualization.py    # Plotting functions
鈹?  鈹斺攢鈹€ models.py           # Probabilistic models
鈹溾攢鈹€ notebooks/              # Jupyter notebooks
鈹?  鈹斺攢鈹€ final_project_analysis.ipynb
鈹溾攢鈹€ data/                   # Data files
鈹?  鈹斺攢鈹€ USCS-1999-2022-ASCII/
...
**Planned Use**: Primary dataset for estimating empirical age鈥搃ncidence curves for different tissues and external validation across SEER tissues.
...
- Stratified downsampling (by age bin 脳 tissue)
- Sparse year grids
...
**Inputs** 鈫?**Parallel Models (A/B/C)** 鈫?**Model Comparison & Calibration** 鈫?**Outputs**
...
**Outputs**:
- Age鈥搑epair efficiency surface: Visualization of how cancer risk varies with age and repair efficiency
